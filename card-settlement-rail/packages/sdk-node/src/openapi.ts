...
export interface paths { '/payout': { post: { requestBody: { content: {'application/json': PayoutRequest} }; responses: { 202: { content: {'application/json': PayoutAccepted} }; 400: { content: {'application/json': ErrorResponse} } } } } }; '/chargeback': { post: { requestBody: { content: {'application/json': ChargebackRequest} }; responses: { 202: { content: {'application/json': ChargebackResponse} } } } } }; '/chargeback/{id}/represent': { post: { requestBody: { content: {'application/json': RepresentmentRequest} }; responses: { 202: { content: {'application/json': ChargebackResponse} } } } } }; '/represent': { post: { requestBody: { content: {'application/json': RepresentmentRequest} }; responses: { 202: { content: {'application/json': RepresentmentResponse} } } } } }; '/reconcile/{date}': { get: { responses: { 200: { content: {'application/json': ReconciliationResponse} } } } } }; }
